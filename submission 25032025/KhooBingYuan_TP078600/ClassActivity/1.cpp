//Write a program that takes a given length as input expressed in feet and inches. Convert and outut the length in centimeters.
//Convert the length in feet and inches to all inches
// - Multiply the number of feet by 12
//Use the conversion formula(1 inch = 2.54 centimeters) to find the equivalent in centimeters
